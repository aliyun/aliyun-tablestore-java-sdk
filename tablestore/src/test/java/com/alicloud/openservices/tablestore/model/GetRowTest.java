...
public class GetRowTest extends BaseFT {
    ...
    public void setup() throws Exception {
        tableName = OTSHelper.generateUniqueTableName("GetRowTest");
    }
    ...
    /**
     * Read without specifying columns; the public returned columns do not include primary key columns.
     * @throws Exception
     */
    @Test
    ...
    /**
     * Specify the primary key column to read; the public returned columns do not include the primary key column.
     * @throws Exception
     */
    @Test
