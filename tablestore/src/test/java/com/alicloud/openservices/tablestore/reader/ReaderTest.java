...
/**
 * Test cases
 * testNormalRead: Use a single-threaded reader to read 10,000 pieces of data from normalTable, all reads succeed.
 * testParallelRead: Use the reader with 4 threads in parallel to read 100,000 pieces of data from normalTable, all reads succeed.
 * testCloseReader: After adding data to memory, close the reader directly; the data in memory can still be queried.
 */
public class ReaderTest {
    ...
    public void testReaderClose() throws InterruptedException {
        ...
        // There will be 99 data entries remaining in the memory.
