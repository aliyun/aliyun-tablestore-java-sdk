...
public class TestTimeseriesWriter {
    ...
    public void setUp() throws Exception {
        ...
        createTimeseriesTable(ots, tableName);
    ...
    public static DefaultTableStoreTimeseriesWriter createWriter(AsyncTimeseriesClient ots, TimeseriesWriterConfig config, Executor executor) {
        ...
        DefaultTableStoreTimeseriesWriter writer = new DefaultTableStoreTimeseriesWriter(serviceSettings.getOTSEndpoint(), credentials, serviceSettings.getOTSInstanceName(), config, callback);
