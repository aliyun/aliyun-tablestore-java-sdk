...
public class TestUnknownExceptionFailed {
    ...
    @Test
    public void testBatchWriteUnknownExceptionFailed() throws Exception {
    ...
    @Test
    public void testBulkImportUnknownExceptionFailed() throws Exception {
