...
public class RestrictedItemTest extends BaseFT {
    ...
    /**
     * Set MaxVersion=3, for attribute columns of different types (INTEGER/BINARY/STRING/BOOLEAN/DOUBLE),
     * the put or update operations in PutRow/UpdateRow/BatchWriteRow, with the same attribute column having 3 versions,
     * read using GetRow and verify;
    ...
    /**
     * Set MaxVersion=3, for attribute columns of different types (INTEGER/BINARY/STRING/BOOLEAN/DOUBLE), 
     * the update operation in UpdateRow or BatchWriteRow repeats the same attribute column 3 times, 
     * and each time it writes to the same attribute column without specifying a timestamp. 
     * Then, read out using GetRow and verify.
     * @throws UnsupportedEncodingException
     */
    @Test
    ...
    /**
     * Test the maximum value of MaxVersions as INT32_MAX and the minimum value as 1. Call all read/write interfaces, expecting normal read/write operations, and verify data correctness.
     */
    @Test
    ...
    /**
     * Test the maximum value of TTL as INT64_MAX and the minimum value as 1. Call all read/write interfaces, 
     * expecting normal read/write operations, to verify the correctness of the data.
     */
    @Test
    ...
    /**
     * The maximum value of the test version is INT64_MAX and the minimum value is 0. Call all read/write interfaces, 
     * expecting normal read/write operations, to verify data correctness.
     */
    @Test
    ...
    /**
     * For each API with a parameter including TableName, the length of TableName is MaxLength + 1, expecting to return ErrorCode: 
     * @throws Exception
     */
    @Test
    ...
    /**
     * For each API that includes the TableName parameter, the length of TableName is MaxLength, and it is expected to work normally.
     * @throws Exception
     */
    @Test
    ...
    /**
     * For each API that includes a parameter with a column name, the length of the column name is MaxLength + 1.
     * Expected return ErrorCode: OTSParameterInvalid
     * @throws Exception
     */
    @Test
    ...
    /**
     * For each API that includes a column name parameter, the length of the column name is MaxLength + 1.
     * Expect to return ErrorCode: OTSParameterInvalid
     * @throws Exception
     */
    @Test
    ...
    /**
     * An instance has max tables. Creating a table is expected to fail. After deleting a table, creating another table is expected to succeed.
     * @throws Exception
     */
    @Test
    ...
    /**
     * For each API that includes PrimaryKeys as parameters, the number of PrimaryKeys is max + 1, expecting to return ErrorCode: OTSParameterInvalid
     * @throws Exception
     */
    @Test
    ...
    /**
     * For each API that includes PrimaryKeys as parameters, the number of PrimaryKeys is maximum, and it is expected to be normal.
     * @throws Exception
     */
    @Test
    ...
    /**
     * For each API that includes PrimaryKeys as parameters, if the number of PrimaryKeys is 0, expect an IllegalArgumentException to be returned.
     * @throws Exception
     */
    @Test
    ...
    /**
     * For each API that includes PrimaryKeys as parameters, the string value of PK is set to max + 1, expecting the return of ErrorCode: OTSParameterInvalid.
     */
    @Test
    ...
    /**
     * For each API that includes PrimaryKeys as parameters, the string value length of PK is expected to be maximum and valid.
     */
    @Test
    ...
    /**
     * For each API that includes PrimaryKeys as parameters, the binary value length of PK is max + 1, and it is expected to return ErrorCode: OTSParameterInvalid
     * @throws UnsupportedEncodingException
     */
    @Test
    ...
    /**
     * For each API that includes PrimaryKeys as parameters, the binary value length of PK is expected to be maximum and valid.
     * @throws UnsupportedEncodingException
     */
    @Test
    ...
    /**
     * For each API that includes column value parameters, if the string value length is max + 1, expect return ErrorCode: OTSParameterInvalid.
     */
    @Test
    ...
    /**
     * For each API that includes column value parameters, the string value length is max, and it is expected to work normally.
     */
    @Test
    ...
    /**
     * For each API that includes column value parameters, the string value length is 0, and it is expected to be normal.
     */
    @Test
    ...
    /**
     * For each API that includes a column value parameter, if the binary value length is max + 1, it is expected to return ErrorCode: OTSParameterInvalid
     * @throws UnsupportedEncodingException
     */
    @Test
    ...
    /**
     * For each API that includes column values in the parameters, the binary value length is maximum, and it is expected to work normally.
     * @throws UnsupportedEncodingException
     */
    @Test
    ...
    /**
     * For each API that includes column value parameters, the binary value length is 0, and it is expected to work normally.
     * @throws UnsupportedEncodingException
     */
    @Test
    ...
    /**
     * The number of rows included in MultiGetRow is max + 1, expecting to return ErrorCode: OTSParameterInvalid.
     */
    @Test
    ...
    /**
     * The number of rows included in MultiGetRow is the maximum, and it is expected to be normal.
     */
    @Test
    ...
    /**
     * The number of rows contained in MultiWriteRow is max + 1, expecting to return ErrorCode: OTSParameterInvalid.
     */
    @Test
    ...
    /**
     * The number of rows included in MultiWriteRow is max, and it is expected to be normal.
     */
    @Test
    ...
    /**
     * A table contains max + 1 rows, total size < max, GetRange is expected to complete reading in 2 attempts.
     */
    @Test
    ...
    /**
     * A table contains max rows, total size < max, GetRange is expected to complete in one read.
     */
    @Test
    ...
    public void testCase35() {
        ...
        // Should not be greater than the maximum limit
     ...
     * PutRow/UpdateRow (including update and delete scenarios) / BatchWriteRow (put/delete/update),
     * test cases include 1024 columns. The expected result is a normal return, 
     * and the data read-out verification matches the expectation.
     */
    @Test
    ...
    /**
     * For all write operations:
     * PutRow/UpdateRow (including update and delete scenarios) / BatchWriteRow (updateChange/delete/update),
     * testing with 1025 columns is expected to return OTSParameterInvalid.
     */
    @Test
    ...
    /**
     * For all read operations GetRow/GetRange/BatchGet, test that ColumnsToGet contains 1024 columns, and expect a normal return.
     */
    @Test
    ...
    /**
     * For all read operations GetRow/GetRange/BatchGet, test that ColumnsToGet contains 1025 columns, expecting an error to be returned.
     */
    @Test
    ...
    /**
     * For the UpdateRow and UpdateRow operation in BatchWriteRow: A row already contains 1024 columns, 
     * and the update successfully adds one column.
     */
    @Test
    ...
    /**
     * Test all APIs with the specified timestamp set to long.max/1000 - 1, expecting normal return.
     */
    @Test
    ...
    /**
     * Test all APIs with the specified timestamp set to long.max/1000, expecting to return OTSParameterInvalid.
     */
    @Test
    ...
    /**
     * Construct the put and update operations for BatchWriteRow with data size exactly 1M, 
     * the types are STRING/BINARY respectively. 
     * Expect to return normally and the verification via BatchGetRow reads passes.
     */
    @Test
    ...
    /**
     * Construct the put and update operations of BatchWriteRow for the case where the data size is exactly 4M + 1, with types being STRING/BINARY respectively.
