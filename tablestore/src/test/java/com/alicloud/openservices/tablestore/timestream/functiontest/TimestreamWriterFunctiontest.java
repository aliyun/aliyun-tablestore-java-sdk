...
public class TimestreamWriterFunctiontest {
    ...
    public void testWriterCallback() throws ExecutionException, InterruptedException {
        ...
        // The callback will be called when the asynchronous data writing fails.
    ...
    /**
     * Verify that the timeline is automatically updated by the backend during data writing
    ...
    public void testMetaUpdate() throws ExecutionException, InterruptedException {
        ...
        /**
         * 1. Write a data point and verify that both data and meta have been updated.
         * 2. Write a point at a different time and verify that the data is updated but the meta is not.
         * 3. Write a point after a meta update and verify that both data and meta have been updated.
         * 4. Delete the meta and verify that the meta no longer exists.
         */
    ...
    /**
     * Close the data writing process, and the timeline will be automatically updated in the background.
     * @throws ExecutionException
     * @throws InterruptedException
     */
    @Test
    public void testMetaNotUpdateWithMetaTable() throws ExecutionException, InterruptedException {
        ...
        /**
         * 1. Write a data point and verify that both data and meta have been updated.
         * 2. Write a point at a different time and verify that the data has been updated but the meta has not.
         * 3. Write a point after the meta has been updated and verify that both data and meta have been updated.
         * 4. Delete the meta and verify that the meta no longer exists.
         */
    ...
    /**
     * Close the data writing process where the timeline is automatically updated in the background, and there is no meta table.
     * @throws ExecutionException
     * @throws InterruptedException
     */
    @Test
    ...
    /**
     * Validate that tag/attribute name does not contain =, " characters
     * @throws ExecutionException
     * @throws InterruptedException
     */
    @Test
