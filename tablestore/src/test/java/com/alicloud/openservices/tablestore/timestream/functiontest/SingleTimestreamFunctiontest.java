...
public class SingleTimestreamFunctiontest {
    ...
    public void testErrorNoDataTable() throws Exception {
        ...
        try {
            ...
            Assert.assertTrue(e.getMessage().contains("Requested table does not exist.")); // There seems to be an issue with OTS itself, as it returns "Internal server error" when the table does not exist, which is not the expected behavior.
        }
    }
