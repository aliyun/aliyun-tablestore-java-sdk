...
public class TestWriterParallel {

    private static final String TABLE_NAME = "WriterTestParallel";
    ...
    private static int bucketCount = 3;
    private static WriteMode writeMode = WriteMode.PARALLEL;
    ...
    public static void main(String[] args) throws Exception {
        ...
        TestWriterParallel tw = new TestWriterParallel();
        tw.setUp();
        tw.testSimple();
        tw.after();
    }
