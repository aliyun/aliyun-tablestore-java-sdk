...
public class ParameterLegalityTest extends BaseFT {
    ...
    /**
     * Test cases for all related APIs where table names are empty, '0', '#', '中文', 'T#', 'T中文', '3t', '-'.
    ...
    /**
     * Test that when using an illegal column name, the expected result is OTSParameterInvalid.
     */
    @Test
    public void testInvalidColumnName() {
        ...
        String columnNames[] = {sb.toString(), "#", "#abc", "#公司", "# "};
    ...
    /**
     * Test using valid column names for operations, expecting the operation to succeed.
     */
    @Test
    ...
    /**
     * Test using VT_INF_MIN or VT_INF_MAX as PK operation, expecting to get OTSParameterInvalid.
     */
    @Test
    ...
    /**
     * Create a table with 3 primary key columns, of types INTEGER, STRING, BINARY.
     * For the GetRange operation, when the start pk and end pk are equal, the expected return is OTSParameterInvalid.
     */
    @Test
    ...
    /**
     * Create a table with 4 primary key columns, namely PK0 INTEGER, PK1 INTEGER, PK2 STRING, PK3 BINARY.
     * Test all data operation APIs using the following PK orders and types:
     ...
     * e) PK3 BINARY, PK1 INTEGER, PK2 STRING, PK0 INTEGER. Expected return OTSParameterInvalid
     */
    @Test
    ...
    /**
     * Create a table without specifying the TTL in the table options, expecting the SDK to throw an error or return OTSParameterInvalid.
     * Create a table without specifying the MaxVersion in the table options, expecting the SDK to throw an error or return OTSParameterInvalid.
     */
    @Test
    ...
    /**
     * In GetRow/GetRange/BatchGetRow, if the version-related parameters are not specified, an error will be returned.
     */
    @Test
