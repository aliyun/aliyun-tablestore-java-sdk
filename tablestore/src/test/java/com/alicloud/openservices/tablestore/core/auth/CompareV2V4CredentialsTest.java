...
import com.aliyun.ots.thirdparty.org.apache.http.client.methods.HttpPost;
...
public class CompareV2V4CredentialsTest {
    ...
    /**
     * Test the performance of v2 signature vs v4 signature
     */
    @Test
    public void testV2V4CredentialsPerformance() throws UnsupportedEncodingException, InterruptedException {
        Thread.sleep(1000);
        {
            ...
            System.out.println("using V2 sign to generate V4 sign, and using V4 sign " + repeatTimes + " times, total time: " + (v4TestEndTime - v4TestStartTime));
        }
        Thread.sleep(1000);
        {
            long v4TestStartTime = System.currentTimeMillis();
            ...
            long v4TestEndTime = System.currentTimeMillis();
            System.out.println("using derived key to generate V4 sign, and using V4 sign " + repeatTimes + " times, total time: " + (v4TestEndTime - v4TestStartTime));
        }
        Thread.sleep(1000);
        {
            ...
            System.out.println("using V2 sign " + repeatTimes + " times, total time: " + (v2TestEndTime - v2TestStartTime));
        }
    }
