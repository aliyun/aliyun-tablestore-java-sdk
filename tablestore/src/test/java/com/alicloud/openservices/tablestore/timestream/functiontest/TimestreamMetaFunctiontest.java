    ...
    public void testLocationCircle() throws Exception {
        ...
        TimestreamMeta meta1 = new TimestreamMeta(
                new TimestreamIdentifier.Builder("company")
                        ...
                        .build())
                .addAttribute("loc", "30.130370, 120.083263"); // Fly Heaven Park

        TimestreamMeta meta2 = new TimestreamMeta(
                new TimestreamIdentifier.Builder("company")
                        .addTag("name", "alibaba2")
                        .build())
                .addAttribute("loc", "30.129237, 120.088380"); // Qianjiang Block

        TimestreamMeta meta3 = new TimestreamMeta(
                new TimestreamIdentifier.Builder("company")
                        .addTag("name", "alibaba3")
                        .build())
                .addAttribute("loc", "30.130188, 120.082112"); // Medium

        TimestreamMeta meta4 = new TimestreamMeta(
                new TimestreamIdentifier.Builder("company")
                        .addTag("name", "alibaba4")
                        .build())
                .addAttribute("loc", "31.207134, 121.343689"); // Shanghai Hongqiao

        TimestreamMeta meta5 = new TimestreamMeta(
                new TimestreamIdentifier.Builder("company")
                        .addTag("name", "aliyun1")
                        .build())
                .addAttribute("loc", "30.280175, 120.024933"); // Future Tech City
        ...
        // Simple circular lookup did not hit
        {
            Filter filter = and(
                    Name.equal("company"),
    ...
    public void testLocationPolygon() throws Exception {
        ...
        TimestreamMeta meta3 = new TimestreamMeta(
                new TimestreamIdentifier.Builder("company")
                        .addTag("name", "alibaba3")
                        .build())
                .addAttribute("loc", "30.130188, 120.082112"); // Medium Large
    ...
    public void testLocationArray() throws Exception {
        ...
        TimestreamMeta meta3 = new TimestreamMeta(
                new TimestreamIdentifier.Builder("company")
                        .addTag("name", "alibaba3")
                        .build())
                .addAttribute("loc", "[\"30.130370, 120.083263\", \"30.129237, 120.088380\"]"); // Medium
