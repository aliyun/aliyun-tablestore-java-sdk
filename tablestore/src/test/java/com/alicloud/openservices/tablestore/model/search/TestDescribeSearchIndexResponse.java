...
public class TestDescribeSearchIndexResponse extends BaseSearchTest {
    ...
    public void jsonizeAll() {
        ...
        indexSchema.addFieldSchema(new FieldSchema("col_fuzzy_keyword", FieldType.FUZZY_KEYWORD)
                ...
                .setVirtualField(true)
                .setSourceFieldNames(Arrays.asList("n1", "f2", "f3")));
        indexSchema.addFieldSchema(new FieldSchema("col_ip", FieldType.IP).setSubFieldSchemas(new ArrayList<>()));
        ...
        indexSchema.addFieldSchema(new FieldSchema("col_json_nested", FieldType.JSON).setJsonType(JsonType.NESTED).setSubFieldSchemas(Arrays.asList(
            new FieldSchema("col_inner", FieldType.TEXT).setSubFieldSchemas(new ArrayList<>()),
            new FieldSchema("col_inner2", FieldType.TEXT).setSubFieldSchemas(new ArrayList<>()).setVirtualField(true).setSourceFieldName("n1")
        )));
