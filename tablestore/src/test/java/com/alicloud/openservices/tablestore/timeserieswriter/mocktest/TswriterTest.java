...
//                                System.out.println("Current number of threads in the queue: " + queueSize);
//
//                                int activeCount = ((ThreadPoolExecutor) executor).getActiveCount();
//                                System.out.println("Current active thread count: " + activeCount);
//
//                                long completedTaskCount = ((ThreadPoolExecutor) executor).getCompletedTaskCount();
//                                System.out.println("Number of completed execution threads: " + completedTaskCount);
//
