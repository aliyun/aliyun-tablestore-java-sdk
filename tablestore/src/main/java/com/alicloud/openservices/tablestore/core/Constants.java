...
public class Constants {
    ...
    // request headers
    public static final String USER_AGENT = "ots-java-sdk 5.17.11";
    ...
    /**
     * The version number of the OTS RESTful API.
     */
    public static final String API_VERSION = "2015-12-31";

    /**
     * Encoding method for OTS requests.
     */
    ...
    /**
     * Timeseries hidden primary key data format
     */
    public static final String TIMESERIES_HIDDEN_PK = "_#h";

    /**
     * The salt value added to the fields to be signed before signing for v4 signature.
