...
public class ListMemoryStoreRequestsRequest extends AbstractMemoryRequest {
    ...
    public ListMemoryStoreRequestsRequest() {
    }

    public ListMemoryStoreRequestsRequest(String memoryStoreName) {
        this.memoryStoreName = memoryStoreName;
    }

    @Override
    public String getOperationName() {
        return OperationNames.OP_LIST_MEMORY_STORE_REQUESTS;
    }
