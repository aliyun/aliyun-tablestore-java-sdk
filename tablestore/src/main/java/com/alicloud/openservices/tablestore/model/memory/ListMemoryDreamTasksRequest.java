...
public class ListMemoryDreamTasksRequest extends AbstractMemoryRequest {
    ...
    public ListMemoryDreamTasksRequest() {
    }

    public ListMemoryDreamTasksRequest(String memoryStoreName, Scope scope) {
    ...
    public String getOperationName() {
        return OperationNames.OP_LIST_MEMORY_DREAM_TASKS;
    }
