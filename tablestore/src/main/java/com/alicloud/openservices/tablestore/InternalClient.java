...
public class InternalClient {
    ...
    private String instanceName; // Name of the instance
    private CredentialsProvider crdsProvider; // User identity information.
    private ResourceManager resourceManager;
    private AsyncServiceClient httpClient;
    private ScheduledExecutorService retryExecutor;
    private ExecutorService callbackExecutor; // Used to execute Callback
     ...
     *
     * @param endpoint
     *            The endpoint of the TableStore service.
     * @param accessKeyId
     *            The Access ID for accessing the TableStore service.
     * @param accessKeySecret
     *            The Access Key for accessing the TableStore service.
     * @param instanceName
     *            The instance name for accessing the TableStore service.
     */
     ...
     *            The instance name for accessing the TableStore service.
     * @param config
     *            The client configuration information ({@link ClientConfiguration}). If null is passed, the default configuration will be used.
     */
    public InternalClient(String endpoint, String accessKeyId, String accessKeySecret, String instanceName,
     ...
     *            The instance name for accessing the TableStore service.
     * @param config
     *            Client configuration information ({@link ClientConfiguration}). If null is passed, the default configuration will be used.
     * @param callbackExecutor
     *            Executes the Callback provided by the user when calling asynchronous interfaces. If null is passed, the default configuration will be used (a thread pool with the same number of threads as CPU cores).
     */
    public InternalClient(String endpoint, String accessKeyId, String accessKeySecret, String instanceName,
     ...
     *            The client configuration information ({@link ClientConfiguration}). If null is passed, the default configuration will be used.
     * @param callbackExecutor
     *            Executes the Callback provided by the user when calling asynchronous interfaces. If null is passed, the default configuration will be used (a thread pool with a number of threads equal to the number of CPU cores).
     * @param stsToken
     *            Sts Token.
     */
    public InternalClient(String endpoint, String accessKeyId, String accessKeySecret, String instanceName,
