...
public class TestTimeseriesWriterInnerConstructClient {
    ...
    public static DefaultTableStoreTimeseriesWriter createWriter(AsyncTimeseriesClient ots, TimeseriesWriterConfig config, Executor executor) {
        ...
        DefaultTableStoreTimeseriesWriter writer = new DefaultTableStoreTimeseriesWriter(ots, config, callback, executor);
