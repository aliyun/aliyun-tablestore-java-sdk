...
public class DataOperationTest extends BaseFT{
    ...
    /**
     * 建一个表，PK为'PK1'，类型为STRING/BINARY/INTEGER，测试所有行操作API，PK为'PK2'类型
    ...
    /**
     * 建一个表，PK为'PK1'，类型为STRING/BINARY/INTEGER，测试所有行操作API，PK为'PK1' 类型与建表时的'PK1'不同，期望返回OTSParameterInvalid
     * @throws Exception
     */
    @Test
    ...
    /**
     * 建一个表，PK为[('PK1', 'STRING'), ('PK2', 'INTEGER'), ('PK3', 'BINARY')]，
     * 测试所有行操作API，
     * PK为{'PK1' : 'blah'}
     * PK为{'PK1' : 'blah', 'PK2' : 123, 'PK4' : 'blah'}
     * PK为{'PK1' : 'blah', 'PK2' : 123, 'PK3' : bytearray(3), 'pk4' : 'blah'},
    ...
    /**
     * 建一个表，PK为[('PK1', 'STRING'), ('PK2', 'INTEGER')]，
     * 测试所有行操作API，
     * PK为{'PK2' : 123, 'PK1', 'blah'}，
     * 期望返回OTSParameterInvalid
     */
    @Test
