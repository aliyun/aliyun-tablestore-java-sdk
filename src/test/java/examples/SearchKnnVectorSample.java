...
public class SearchKnnVectorSample {
    ...
    private static void createSearchIndex(SyncClient client) {
        ...
        indexSchema.setFieldSchemas(Arrays.asList(
                ...
                new FieldSchema("Col_Vector", FieldType.VECTOR).setIndex(true).setVectorOptions(new VectorOptions(VectorDataType.FLOAT_32, 4, VectorMetricType.COSINE, new HNSWIndexParameter(16, 100)))
        ));
    ...
    private static void knnVectorQuery(SyncClient client) {
        ...
        // 最相近的向量需要满足: Col_Keyword=hangzhou
