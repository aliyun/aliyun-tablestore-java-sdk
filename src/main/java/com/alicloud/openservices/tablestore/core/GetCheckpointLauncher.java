...
import com.alicloud.openservices.tablestore.core.http.GetCheckpointResponseConsumer;
...
public class GetCheckpointLauncher
    extends OperationLauncher<GetCheckpointRequest, GetCheckpointResponse> {
    private OTSUri uri;
    private TraceLogger tracer;
    private RetryStrategy retry;

    public GetCheckpointLauncher(
        OTSUri uri,
        TraceLogger tracer,
        RetryStrategy retry,
        String instanceName,
